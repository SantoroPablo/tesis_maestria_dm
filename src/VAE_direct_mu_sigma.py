...
class VAE_direct(nn.Module):
    ...
    def __init__(self, h_dim=40, z_dim=4):
        ...
        # 8x5x5
        self.fc2 = nn.Linear(8**4, z_dim)  # FC MU
        self.fc3 = nn.Linear(8**4, z_dim)  # FC STD
        self.fc5 = nn.Linear(z_dim, 8**4) # FC internal dec
